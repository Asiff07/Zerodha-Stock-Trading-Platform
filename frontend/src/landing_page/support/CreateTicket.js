        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                ...
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa fa-plus-circle" aria-hidden="true"></i>Account Opening</h4>
                ...
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa-solid fa-user"></i>Your Zerodha Account</h4>
                ...
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa-solid fa-chart-simple"></i>Your Zerodha Account</h4>
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>Mervin/Levarage, Product and Order types</a> <br />
                    ...
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>Kite APIs</a> <br />
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>Pi and other platform</a> <br />
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>Stockreport+</a> <br />
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>GTT+</a> <br />
                </div>
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa-solid fa-credit-card"></i>Funds</h4>
                ...
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa-solid fa-circle-notch"></i>Console</h4>
                ...
                <div className="col-4 p-5 mt-5">
                    <h4 className='mb-3'><i style={{ marginRight: "0.5rem" }} class="fa-regular fa-circle"></i>Coin</h4>
                    ...
                    <a href="/" style={{ textDecoration: "none", lineHeight: "2.5" }}>Buying and Selling using Coin </a> <br />
